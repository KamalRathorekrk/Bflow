...
class RoutesDetails {
  RoutesDetails({
      ...
      int? orderTransmissionStatusId, 
      String? orderPickUpDate, 
      int? deliveryMethodId, 
      int? claimFrequencyTypeId, 
      String? insuranceClaimNumber, 
      int? orderStateID, 
      int? claimDelayReasonCode, 
      String? comments, 
      String? driverName, 
      String? birthDate, 
  ...
  int? _orderTransmissionStatusId;
  String? _orderPickUpDate;
  int? _deliveryMethodId;
  int? _claimFrequencyTypeId;
  String? _insuranceClaimNumber;
  int? _orderStateID;
  int? _claimDelayReasonCode;
  String? _comments;
  String? _driverName;
  String? _birthDate;
  ...
  int? get orderTransmissionStatusId => _orderTransmissionStatusId;
  String? get orderPickUpDate => _orderPickUpDate;
  int? get deliveryMethodId => _deliveryMethodId;
  int? get claimFrequencyTypeId => _claimFrequencyTypeId;
  String? get insuranceClaimNumber => _insuranceClaimNumber;
  int? get orderStateID => _orderStateID;
  int? get claimDelayReasonCode => _claimDelayReasonCode;
